...
return [
    ...
    'errors' => [
        ...
        'email_already_associated' => 'Uma conta com esse endereço de email já existe. Por favor, faça login para conectar sua conta :Provider.',
        ...
        'already_connected' => 'Uma conta com esse endereço de email já existe. Por favor, faça login para conectar sua conta :Provider.',
    ...
    'descriptions' => [
        'token_created_state' => 'Criado :time_ago por :user_name.',
        'token_last_used_state' => 'Último uso :time_ago',
        'token_never_used' => 'Nunca usado',
        'token_updated_state' => 'Atualizado :time_ago',
    ],

    'banner' => [
        'company_invitation_accepted' => 'Ótimo! Você aceitou o convite para se juntar à **:company**.',
    ],
    ...
    'notifications' => [
        ...
        'browser_sessions_terminated' => [
            'title' => 'Sessões do navegador encerradas',
        ...
        'successfully_connected' => [
            'title' => 'Sucesso!',
            'body' => 'Você conectou com sucesso :Provider à sua conta.',
        ],
    ...
    'navigation' => [
        'headers' => [
            ...
            'switch_companies' => 'Trocar Empresas',
        ],
    ...
    'grid_section_descriptions' => [
        ...
        'browser_sessions' => 'Gerencie e saia de suas sessões ativas em outros navegadores e dispositivos.',
        'company_name' => 'O nome da empresa e as informações do proprietário.',
        'create_token' => 'Tokens de Acesso Pessoal permitem que serviços de terceiros autentiquem-se com nosso aplicativo em seu nome.',
        'create_company' => 'Crie uma nova empresa para colaborar com outros em projetos.',
        'delete_account' => 'Exclua permanentemente sua conta.',
        'profile_information' => 'Atualize as informações do perfil da sua conta e o endereço de email.',
        'set_password' => 'Garanta que sua conta esteja usando uma senha longa e aleatória para se manter segura.',
        'two_factor_authentication' => 'Adicione segurança adicional à sua conta usando autenticação de dois fatores.',
        'update_password' => 'Garanta que sua conta esteja usando uma senha longa e aleatória para se manter segura.',
    ],
    ...
    'action_section_titles' => [
        ...
        'delete_company' => 'Excluir Empresa',
        'pending_company_invitations' => 'Convites Pendentes da Empresa',
    ],
    ...
    'action_section_descriptions' => [
        ...
        'delete_company' => 'Exclua permanentemente esta empresa.',
        'pending_company_invitations' => 'Essas pessoas foram convidadas para sua empresa e receberam um email de convite. Elas podem se juntar à empresa aceitando o convite por email.',
    ],
    ...
    'modal_descriptions' => [
        ...
        'delete_token' => 'Tem certeza de que deseja excluir este Token de Acesso Pessoal?',
        'delete_company' => 'Tem certeza de que deseja excluir esta empresa?',
        'leave_company' => 'Tem certeza de que deseja sair desta empresa?',
        'logout_browser_sessions' => 'Por favor, insira sua senha para confirmar que deseja sair de suas outras sessões do navegador.',
        'remove_company_employee' => 'Tem certeza de que deseja remover esta pessoa da empresa?',
    ...
    'headings' => [
        'auth' => [
            ...
            'verify_email' => [
                'verification_link_not_sent' => 'Antes de continuar, você poderia verificar seu endereço de email clicando no link que acabamos de enviar para você? Se você não recebeu o email, enviaremos outro com prazer.',
                'verification_link_sent' => 'Um novo link de verificação foi enviado para o endereço de email fornecido nas configurações do seu perfil.',
            ],
        ],
        ...
        'profile' => [
            ...
            'two_factor_authentication' => [
                ...
                'finish_enabling' => 'Conclua a ativação da autenticação de dois fatores.',
    ...
    'subheadings' => [
        'auth' => [
            'forgot_password' => 'Apenas nos informe seu endereço de email e enviaremos um link de redefinição de senha que permitirá que você escolha uma nova.',
            'login' => 'Ou',
            'register' => 'Eu concordo com os :terms_of_service e :privacy_policy',
        ],

        'profile' => [
            'two_factor_authentication' => [
                'enabled' => 'A autenticação de dois fatores está agora ativada. Escaneie o código QR a seguir usando o aplicativo autenticador do seu telefone ou insira a chave de configuração.',
                'finish_enabling' => 'Para concluir a ativação da autenticação de dois fatores, escaneie o código QR a seguir usando o aplicativo autenticador do seu telefone ou insira a chave de configuração e forneça o código OTP gerado.',
                'store_codes' => 'Armazene esses códigos de recuperação em um gerenciador de senhas seguro. Eles podem ser usados para recuperar o acesso à sua conta se o dispositivo de autenticação de dois fatores for perdido.',
                'summary' => 'Quando a autenticação de dois fatores está ativada, você será solicitado a fornecer um token seguro e aleatório durante a autenticação. Você pode obter esse token no aplicativo Google Authenticator do seu telefone.',
            ],

            'connected_accounts' => 'Você pode conectar qualquer conta social ao seu perfil e pode remover qualquer conta conectada a qualquer momento. Se você sentir que alguma de suas contas conectadas foi comprometida, deve desconectá-las imediatamente e alterar sua senha.',
            'delete_user' => 'Uma vez que sua conta for excluída, todos os seus recursos e dados serão permanentemente excluídos. Antes de excluir sua conta, por favor, baixe quaisquer dados ou informações que você deseja reter.',
        ...
        'companies' => [
            ...
            'delete_company' => 'Uma vez que uma empresa for excluída, todos os seus recursos e dados serão permanentemente excluídos. Antes de excluir esta empresa, por favor, baixe quaisquer dados ou informações sobre esta empresa que você deseja reter.',
        ],
    ],
];
